...
<a href='ask.php'><button id='ask_button_top'>Ask Question</button></a>
...
<center>
    <div class='container' style='text-align:left'>
        ...
        <div class='profile' id='buttonForm'>
            <center>
                <a href='ask.php'><button class='ask_button_bottom'>Ask Question</button></a>
            </center>
        </div>
...
<a href='ask.php'>
    <div id='ask_question_pencil'>
        <img src='/quesans/images/edit.png' />
    </div>
</a>
