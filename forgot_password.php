...
if (isset($_POST['submit'])) {
	...
	while($row=mysqli_fetch_array($result)){
		...
		$otp="Use this email and password to login to your Answer Account.\nEmail: ".$email."\nPassword: ".$pass."\nUsername: ".$user."";
		...
		*/
		...
		$mail->setFrom('alloasktechnologies@gmail.com', 'Answer'); // Set the sender of the message.
		$mail->addAddress($email , $username); // Set the recipient of the message.
		$mail->Subject = 'This is your password for Answer.'; // The subject of the message.
		...
		*/
		...
		mail($email,'This is your OTP(One Time Password) for Answer.',$otp);
...
<center>
	<div class='container'>
		<form action=<?php echo "forgot_password.php"; ?> method="POST" >
			<br>
			<p style='color:white;'>Enter Your Email. We'll send your password to your email.</p>
